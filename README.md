...
<div style="width:98%; height=201px">
    <div style="text-align: left" float="left">
        <img src="https://github.com/ChiefMonk/CMPG-323-Overview-37016776/blob/main/nwu_logo.jpg" width="200px" style="text-align:left;float: left" />
    </div>
    <div style="text-align: right" float="right">
        <img src="https://github.com/ChiefMonk/CMPG-323-Overview-37016776/blob/main/nwu_it.png" width="200px" style="text-align:right;float: right" />
    </div>
</div>
