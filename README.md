...
<div style="width:98%; height:300px">
    <img src="https://github.com/ChiefMonk/CMPG-323-Overview-37016776/blob/main/nwu_logo.jpg" 
        width="200"
        height="200"
        style="text-align:left; width=200px; margin-left: 10px" />
        
    <img src="https://github.com/ChiefMonk/CMPG-323-Overview-37016776/blob/main/nwu_it.png" 
         width="200"
        height="200"
        style="text-align: right;width=200px;margin-right: 10px" /> 
</div>
